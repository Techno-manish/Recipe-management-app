...
import DraggableRecipeBoard from "../components/DraggableRecipeBoard.jsx";
...
export default function MyRecipes() {
  ...
  return (
    <>
      ...
      <div className="myDraggableRecipesContainer container">
        <p className="sectionHeading">Manage Recipes</p>
        <DraggableRecipeBoard />
      </div>
    </>
  );
}
